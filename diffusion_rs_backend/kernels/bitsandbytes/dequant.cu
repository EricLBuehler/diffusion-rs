...
extern "C" void dequantize_blockwise_f32_int8(float *code, unsigned char *A, float *absmax, float *out, int blocksize, const int n, cudaStream_t stream) {
    dequantizeBlockwise<float, General8bit>(code, A, absmax, out, blocksize, n, stream);
}
extern "C" void dequantize_blockwise_f32_fp4(float *code, unsigned char *A, float *absmax, float *out, int blocksize, const int n, cudaStream_t stream) {
    dequantizeBlockwise<float, FP4>(code, A, absmax, out, blocksize, n, stream);
}
extern "C" void dequantize_blockwise_f32_nf4(float *code, unsigned char *A, float *absmax, float *out, int blocksize, const int n, cudaStream_t stream) {
    dequantizeBlockwise<float, NF4>(code, A, absmax, out, blocksize, n, stream);
}

extern "C" void dequantize_blockwise_f16_int8(float *code, unsigned char *A, float *absmax, __half *out, int blocksize, const int n, cudaStream_t stream) {
    dequantizeBlockwise<__half, General8bit>(code, A, absmax, out, blocksize, n, stream);
}
extern "C" void dequantize_blockwise_f16_fp4(float *code, unsigned char *A, float *absmax, __half *out, int blocksize, const int n, cudaStream_t stream) {
    dequantizeBlockwise<__half, FP4>(code, A, absmax, out, blocksize, n, stream);
}
extern "C" void dequantize_blockwise_f16_nf4(float *code, unsigned char *A, float *absmax, __half *out, int blocksize, const int n, cudaStream_t stream) {
    dequantizeBlockwise<__half, NF4>(code, A, absmax, out, blocksize, n, stream);
}

// #if __CUDA_ARCH__ >= 800
extern "C" void dequantize_blockwise_bf16_int8(float *code, unsigned char *A, float *absmax, __nv_bfloat16 *out, int blocksize, const int n, cudaStream_t stream) {
    dequantizeBlockwise<__nv_bfloat16, General8bit>(code, A, absmax, out, blocksize, n, stream);
}
extern "C" void dequantize_blockwise_bf16_fp4(float *code, unsigned char *A, float *absmax, __nv_bfloat16 *out, int blocksize, const int n, cudaStream_t stream) {
    dequantizeBlockwise<__nv_bfloat16, FP4>(code, A, absmax, out, blocksize, n, stream);
}
extern "C" void dequantize_blockwise_bf16_nf4(float *code, unsigned char *A, float *absmax, __nv_bfloat16 *out, int blocksize, const int n, cudaStream_t stream) {
