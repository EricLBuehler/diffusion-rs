...
macro_rules! unary_op {
    ($fn_name:ident, $op_name:ident) => {
        pub fn $fn_name(&self) -> Result<Self> {
            ...
            let storage = self
                .storage()
                .unary_impl::<crate::core::op::$op_name>(self.layout())?;
...
macro_rules! binary_op {
    ($fn_name:ident, $op_name:ident) => {
        pub fn $fn_name(&self, rhs: &Self) -> Result<Self> {
            ...
            let storage = self.storage().binary_impl::<crate::core::op::$op_name>(
                &*rhs.storage(),
                self.layout(),
                rhs.layout(),
            )?;
    ...
    ($fn_name:ident, $op_name:ident) => {
        pub fn $fn_name<T: TensorOrScalar>(&self, rhs: T) -> Result<Self> {
            let rhs = match rhs.to_tensor_scalar()? {
                crate::core::scalar::TensorScalar::Tensor(rhs) => rhs,
                crate::core::scalar::TensorScalar::Scalar(rhs) => rhs
                    .to_dtype(self.dtype())?
...
impl Tensor {
    ...
    pub(crate) fn rand_impl<S: Into<Shape>, T: crate::core::FloatDType>(
        lo: T,
        up: T,
        s: S,
        device: &Device,
    ...
    pub fn rand<S: Into<Shape>, T: crate::core::FloatDType>(
        lo: T,
        up: T,
        s: S,
        device: &Device,
    ...
    pub(crate) fn randn_impl<S: Into<Shape>, T: crate::core::FloatDType>(
        mean: T,
        std: T,
        s: S,
        device: &Device,
    ...
    pub fn randn<S: Into<Shape>, T: crate::core::FloatDType>(
        mean: T,
        std: T,
        s: S,
        device: &Device,
    ...
    pub(crate) fn new_impl<A: crate::core::device::NdArray>(
        array: A,
        shape: Shape,
        device: &Device,
        is_variable: bool,
    ...
    pub fn new<A: crate::core::device::NdArray>(array: A, device: &Device) -> Result<Self> {
    ...
    /// ]);
    /// # Ok::<(), diffusion_rs_common::core::Error>(())
    pub fn full<D: crate::core::WithDType, S: Into<Shape>>(
        value: D,
        shape: S,
        device: &Device,
    ) -> Result<Self> {
    ...
    /// # Ok::<(), diffusion_rs_common::core::Error>(())
    /// ```
    pub fn from_iter<D: crate::core::WithDType>(
    ...
    /// # Ok::<(), diffusion_rs_common::core::Error>(())
    /// ```
    pub fn arange<D: crate::core::WithDType>(start: D, end: D, device: &Device) -> Result<Self> {
    ...
    /// # Ok::<(), diffusion_rs_common::core::Error>(())
    /// ```
    pub fn arange_step<D: crate::core::WithDType>(
        start: D,
        end: D,
        step: D,
        device: &Device,
    ...
    pub(crate) fn from_vec_impl<S: Into<Shape>, D: crate::core::WithDType>(
        data: Vec<D>,
        shape: S,
        device: &Device,
        is_variable: bool,
    ...
    /// # Ok::<(), diffusion_rs_common::core::Error>(())
    /// ```
    pub fn from_vec<S: Into<Shape>, D: crate::core::WithDType>(
        data: Vec<D>,
        shape: S,
        device: &Device,
    ) -> Result<Self> {
    ...
    /// # Ok::<(), diffusion_rs_common::core::Error>(())
    /// ```
    pub fn from_slice<S: Into<Shape>, D: crate::core::WithDType>(
        array: &[D],
        shape: S,
        device: &Device,
    ) -> Result<Self> {
    ...
    pub fn to_scalar<S: crate::core::WithDType>(&self) -> Result<S> {
        if self.rank() != 0 {
        ...
        let from_cpu_storage = |cpu_storage: &crate::core::CpuStorage| {
    ...
    pub fn to_vec0<S: crate::core::WithDType>(&self) -> Result<S> {
        self.to_scalar::<S>()
    }
    ...
    pub fn avg_pool2d<T: crate::core::ToUsize2>(&self, sz: T) -> Result<Self> {
        let sz = sz.to_usize2();
    ...
    /// kernel size.
    pub fn avg_pool2d_with_stride<T: crate::core::ToUsize2>(
        &self,
        kernel_size: T,
        stride: T,
    ) -> Result<Self> {
    ...
    /// value over the kernel window.
    pub fn max_pool2d<T: crate::core::ToUsize2>(&self, sz: T) -> Result<Self> {
        let sz = sz.to_usize2();
    ...
    /// kernel size.
    pub fn max_pool2d_with_stride<T: crate::core::ToUsize2>(
        &self,
        kernel_size: T,
        stride: T,
    ) -> Result<Self> {
    ...
    pub fn strided_index(&self) -> crate::core::StridedIndex {
    ...
    /// tensor.
    pub fn strided_blocks(&self) -> crate::core::StridedBlocks {
        self.layout.strided_blocks()
    }

    /// Returns the data contained in a 1D tensor as a vector of scalar values.
    pub fn to_vec1<S: crate::core::WithDType>(&self) -> Result<Vec<S>> {
        if self.rank() != 1 {
            Err(Error::UnexpectedNumberOfDims {
                expected: 1,
                got: self.rank(),
    ...
    pub fn to_vec2<S: crate::core::WithDType>(&self) -> Result<Vec<Vec<S>>> {
    ...
    pub fn to_vec3<S: crate::core::WithDType>(&self) -> Result<Vec<Vec<Vec<S>>>> {
    ...
    /// # Ok::<(), diffusion_rs_common::core::Error>(())
    /// ```
    pub fn reshape<S: crate::core::shape::ShapeWithOneHole>(&self, s: S) -> Result<Tensor> {
    ...
    pub fn apply<M: crate::core::Module>(&self, m: &M) -> Result<Self> {
        m.forward(self)
    }

    /// Run the `forward` method of `m` on `self`.
    pub fn apply_t<M: crate::core::ModuleT>(&self, m: &M, train: bool) -> Result<Self> {
