...
pub trait Dim: crate::core::shape::Dim + Copy {}
impl<T: crate::core::shape::Dim + Copy> Dim for T {}
...
pub struct StreamingBinOp {
    ...
    pub op: BinOp,
    pub dim: crate::core::D,
}

impl StreamingBinOp {
    pub fn new(op: BinOp, dim: crate::core::D) -> Self {
        Self {
...
pub struct Map<T: crate::core::Module>(T);

impl<T: crate::core::Module> StreamingModule for Map<T> {
    fn reset_state(&mut self) {}
