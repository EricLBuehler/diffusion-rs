...
use crate::core::{backend::BackendDevice, cuda_backend::WrapErr};
use crate::core::{CudaDevice, CudaStorage, Result};
use half::f16;
...
fn quantize_q8_1(
    ...
    let func = dev.get_or_load_func("quantize_q8_1", crate::cuda_kernels::QUANTIZED)?;
...
fn dequantize_f32(
    ...
    let func = dev.get_or_load_func(kernel_name, crate::cuda_kernels::QUANTIZED)?;
...
impl QCudaStorage {
    ...
    pub fn dequantize(&self, elem_count: usize) -> Result<CudaStorage> {
        ...
        self.device
            .storage_from_cpu_storage(&crate::core::CpuStorage::F32(out))
    }
    ...
    pub fn quantize(&mut self, src: &CudaStorage) -> Result<()> {
        ...
        let src = match &src.slice {
            crate::core::cuda_backend::CudaStorageSlice::F32(data) => {
        ...
        let mut qcpu_storage = crate::core::Device::Cpu.qzeros(src_len, self.dtype)?;
...
impl QCudaStorage {
    fn dequantize_matmul_vec(
        ...
        self_shape: &crate::core::Shape,
        rhs: &CudaStorage,
        rhs_l: &crate::core::Layout,
    ) -> Result<(CudaStorage, crate::core::Shape)> {
        let (nrows, ncols) = self_shape.dims2()?;
        let rhs = rhs.as_cuda_slice::<f32>()?;
        let rhs = match rhs_l.contiguous_offsets() {
            Some((o1, o2)) => rhs.slice(o1..o2),
            None => Err(crate::core::Error::RequiresContiguous { op: "dmmv" }.bt())?,
        };
    ...
    fn dequantize_matmul(
        ...
        let out = if FORCE_DMMV.load(std::sync::atomic::Ordering::Relaxed) {
            ...
            let storage = match layout.contiguous_offsets() {
                ...
                None => Err(crate::core::Error::RequiresContiguous {
                    op: "quantized-matmul",
                }
                .bt())?,
            };
