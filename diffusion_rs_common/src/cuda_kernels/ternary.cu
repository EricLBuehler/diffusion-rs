...
WHERE_OP(int8_t, int32_t, where_i32_i8)
...
WHERE_OP(int8_t, int64_t, where_i64_i8)
...
WHERE_OP(int8_t, uint32_t, where_u32_i8)
...
WHERE_OP(int8_t, uint8_t, where_u8_i8)
...
WHERE_OP(float, int8_t, where_i8_f32)
WHERE_OP(double, int8_t, where_i8_f64)
WHERE_OP(int8_t, int8_t, where_i8_i8)
WHERE_OP(uint8_t, int8_t, where_i8_u8)
WHERE_OP(uint32_t, int8_t, where_i8_u32)
WHERE_OP(int16_t, int8_t, where_i8_i16)
WHERE_OP(int32_t, int8_t, where_i8_i32)
WHERE_OP(int64_t, int8_t, where_i8_i64)
