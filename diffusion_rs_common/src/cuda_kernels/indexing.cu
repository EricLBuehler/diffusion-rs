...
IS_OP(__nv_bfloat16, int8_t, is_i8_bf16)
...
GATHER_OP(__nv_bfloat16, int8_t, gather_i8_bf16)
...
IA_OP(__nv_bfloat16, int8_t, ia_i8_bf16)
...
SA_OP(__nv_bfloat16, int8_t, sa_i8_bf16)
...
IS_OP(__nv_fp8_e4m3, int8_t, is_i8_f8_e4m3)
...
GATHER_OP(__nv_fp8_e4m3, int8_t, gather_i8_f8_e4m3)
...
IA_OP_F8(__nv_fp8_e4m3, int8_t, ia_i8_f8_e4m3)
...
SA_OP_F8(__nv_fp8_e4m3, int8_t, sa_i8_f8_e4m3)
#endif
...
GATHER_OP(__half, int8_t, gather_i8_f16)
...
IS_OP(int8_t, int32_t, is_i32_i8)
...
IS_OP(int8_t, int64_t, is_i64_i8)
...
IS_OP(int8_t, uint32_t, is_u32_i8)
...
IS_OP(float, int8_t, is_i8_f32)
IS_OP(double, int8_t, is_i8_f64)
IS_OP(uint8_t, int8_t, is_i8_u8)
IS_OP(int8_t, int8_t, is_i8_i8)
IS_OP(uint32_t, int8_t, is_i8_u32)
IS_OP(int16_t, int8_t, is_i8_i16)
IS_OP(int32_t, int8_t, is_i8_i32)
IS_OP(int64_t, int8_t, is_i8_i64)

GATHER_OP(float, int16_t, gather_i16_f32)
GATHER_OP(double, int16_t, gather_i16_f64)
GATHER_OP(uint8_t, int16_t, gather_i16_u8)
GATHER_OP(int8_t, int16_t, gather_i16_i8)
...
GATHER_OP(int8_t, int32_t, gather_i32_i8)
...
GATHER_OP(int8_t, int64_t, gather_i64_i8)
...
GATHER_OP(int8_t, uint32_t, gather_u32_i8)
...
GATHER_OP(int8_t, uint8_t, gather_u8_i8)
...
GATHER_OP(float, int8_t, gather_i8_f32)
GATHER_OP(double, int8_t, gather_i8_f64)
GATHER_OP(uint8_t, int8_t, gather_i8_u8)
GATHER_OP(int8_t, int8_t, gather_i8_i8)
GATHER_OP(uint32_t, int8_t, gather_i8_u32)
GATHER_OP(int16_t, int8_t, gather_i8_i16)
GATHER_OP(int32_t, int8_t, gather_i8_i32)
GATHER_OP(int64_t, int8_t, gather_i8_i64)

IA_OP(float, int16_t, ia_i16_f32)
IA_OP(double, int16_t, ia_i16_f64)
IA_OP(uint8_t, int16_t, ia_i16_u8)
IA_OP(int8_t, int16_t, ia_i16_i8)
...
IA_OP(int8_t, int32_t, ia_i32_i8)
...
IA_OP(int8_t, int64_t, ia_i64_i8)
...
IA_OP(int8_t, uint32_t, ia_u32_i8)
...
IA_OP(int8_t, uint8_t, ia_u8_i8)
IA_OP(uint32_t, uint8_t, ia_u8_u32)
IA_OP(int16_t, uint8_t, ia_u8_i16)
IA_OP(int32_t, uint8_t, ia_u8_i32)
IA_OP(int64_t, uint8_t, ia_u8_i64)

IA_OP(float, int8_t, ia_i8_f32)
IA_OP(double, int8_t, ia_i8_f64)
IA_OP(uint8_t, int8_t, ia_i8_u8)
IA_OP(int8_t, int8_t, ia_i8_i8)
IA_OP(uint32_t, int8_t, ia_i8_u32)
IA_OP(int16_t, int8_t, ia_i8_i16)
IA_OP(int32_t, int8_t, ia_i8_i32)
IA_OP(int64_t, int8_t, ia_i8_i64)

SA_OP(float, int16_t, sa_i16_f32)
SA_OP(double, int16_t, sa_i16_f64)
SA_OP(uint8_t, int16_t, sa_i16_u8)
SA_OP(int8_t, int16_t, sa_i16_i8)
...
SA_OP(int8_t, int32_t, sa_i32_i8)
...
SA_OP(int8_t, int64_t, sa_i64_i8)
...
SA_OP(int8_t, uint32_t, sa_u32_i8)
...
SA_OP(float, int8_t, sa_i8_f32)
SA_OP(double, int8_t, sa_i8_f64)
SA_OP(uint8_t, int8_t, sa_i8_u8)
SA_OP(int8_t, int8_t, sa_i8_i8)
SA_OP(uint32_t, int8_t, sa_i8_u32)
SA_OP(int16_t, int8_t, sa_i8_i16)
SA_OP(int32_t, int8_t, sa_i8_i32)
SA_OP(int64_t, int8_t, sa_i8_i64)
