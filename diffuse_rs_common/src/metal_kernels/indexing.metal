...
INDEX_OP(is_u32_i8, uint32_t, int8_t)
...
INDEX_OP(is_u8_i8, uint8_t, int8_t)
...
INDEX_OP(is_i8_i8, int8_t, int8_t)
INDEX_OP(is_i8_u8, int8_t, uint8_t)
INDEX_OP(is_i8_u32, int8_t, uint32_t)
INDEX_OP(is_i8_f32, int8_t, float)
INDEX_OP(is_i8_f16, int8_t, half)
INDEX_OP(is_i8_bf16, int8_t, bfloat16_t)
...
INDEX_ADD_OP(ia_i64_i8, int64_t, int8_t)
...
INDEX_ADD_OP(ia_i32_i8, int32_t, int8_t)
...
INDEX_ADD_OP(ia_i16_i8, int16_t, int8_t)
...
INDEX_ADD_OP(ia_u32_i8, uint32_t, int8_t)
...
INDEX_ADD_OP(ia_u8_i8, uint8_t, int8_t)
INDEX_ADD_OP(ia_u8_bf16, uint8_t, bfloat16_t)

// i8
INDEX_ADD_OP(ia_i8_f16, int8_t, half)
INDEX_ADD_OP(ia_i8_f32, int8_t, float)
INDEX_ADD_OP(ia_i8_i16, int8_t, int16_t)
INDEX_ADD_OP(ia_i8_i32, int8_t, int32_t)
INDEX_ADD_OP(ia_i8_i64, int8_t, int64_t)
INDEX_ADD_OP(ia_i8_u32, int8_t, uint32_t)
INDEX_ADD_OP(ia_i8_u8, int8_t, uint8_t)
INDEX_ADD_OP(ia_i8_i8, int8_t, int8_t)
INDEX_ADD_OP(ia_i8_bf16, int8_t, bfloat16_t)
