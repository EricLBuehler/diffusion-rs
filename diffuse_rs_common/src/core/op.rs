...
pub enum Op {
    ...
    CustomOp1(
        Tensor,
        std::sync::Arc<Box<dyn crate::core::CustomOp1 + Send + Sync>>,
    ),
    CustomOp2(
        Tensor,
        Tensor,
        std::sync::Arc<Box<dyn crate::core::CustomOp2 + Send + Sync>>,
    ),
    CustomOp3(
        Tensor,
        Tensor,
        Tensor,
        std::sync::Arc<Box<dyn crate::core::CustomOp3 + Send + Sync>>,
    ),
}
    ...
    ($op:ident, $name: literal, $e: expr, $f32_vec: ident, $f64_vec: ident) => {
        impl BinaryOpT for $op {
            ...
            fn f32_vec(xs1: &[f32], xs2: &[f32], ys: &mut [f32]) {
                crate::core::mkl::$f32_vec(xs1, xs2, ys)
            }
            #[cfg(feature = "mkl")]
            #[inline(always)]
            fn f64_vec(xs1: &[f64], xs2: &[f64], ys: &mut [f64]) {
                crate::core::mkl::$f64_vec(xs1, xs2, ys)
            }
            ...
            #[inline(always)]
            fn f32_vec(xs1: &[f32], xs2: &[f32], ys: &mut [f32]) {
                crate::core::accelerate::$f32_vec(xs1, xs2, ys)
            }
            #[cfg(feature = "accelerate")]
            #[inline(always)]
            fn f64_vec(xs1: &[f64], xs2: &[f64], ys: &mut [f64]) {
                crate::core::accelerate::$f64_vec(xs1, xs2, ys)
            }
        }
    };
}
    ...
    ($op: ident, $name: literal, $a: ident, $e: expr, $f32_vec:ident, $f64_vec:ident) => {
        impl UnaryOpT for $op {
            ...
            fn f32_vec(xs: &[f32], ys: &mut [f32]) {
                crate::core::mkl::$f32_vec(xs, ys)
            }
            #[cfg(feature = "mkl")]
            #[inline(always)]
            fn f64_vec(xs: &[f64], ys: &mut [f64]) {
                crate::core::mkl::$f64_vec(xs, ys)
            }
            ...
            #[inline(always)]
            fn f32_vec(xs: &[f32], ys: &mut [f32]) {
                crate::core::accelerate::$f32_vec(xs, ys)
            }
            #[cfg(feature = "accelerate")]
            #[inline(always)]
            fn f64_vec(xs: &[f64], ys: &mut [f64]) {
                crate::core::accelerate::$f64_vec(xs, ys)
            }
        }
    };
}
...
impl UnaryOpT for Gelu {
    ...
    #[inline(always)]
    fn f32_vec(xs: &[f32], ys: &mut [f32]) {
        crate::core::accelerate::vs_gelu(xs, ys)
    }
    ...
    #[inline(always)]
    fn f64_vec(xs: &[f64], ys: &mut [f64]) {
        crate::core::accelerate::vd_gelu(xs, ys)
    }
}
...
impl UnaryOpT for Silu {
    ...
    #[inline(always)]
    fn f32_vec(xs: &[f32], ys: &mut [f32]) {
        crate::core::accelerate::vs_silu(xs, ys)
    }
    ...
    #[inline(always)]
    fn f64_vec(xs: &[f64], ys: &mut [f64]) {
        crate::core::accelerate::vd_silu(xs, ys)
    }
}
...
impl UnaryOpT for GeluErf {
    ...
    #[inline(always)]
    fn f64(v: f64) -> f64 {
        (crate::core::cpu::erf::erf(v / 2f64.sqrt()) + 1.) * 0.5 * v
    }
    #[inline(always)]
    fn i8(_: i8) -> i8 {
        0
