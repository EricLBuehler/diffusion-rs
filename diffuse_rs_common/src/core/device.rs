...
use crate::core::cpu_backend::CpuDevice;
use crate::core::{CpuStorage, DType, Result, Shape, Storage, WithDType};
...
pub enum Device {
    Cpu,
    Cuda(crate::core::CudaDevice),
    Metal(crate::core::MetalDevice),
}
...
impl Device {
    pub fn new_cuda(ordinal: usize) -> Result<Self> {
        Ok(Self::Cuda(crate::core::CudaDevice::new(ordinal)?))
    }

    pub fn as_cuda_device(&self) -> Result<&crate::core::CudaDevice> {
        match self {
            Self::Cuda(d) => Ok(d),
    ...
    pub fn as_metal_device(&self) -> Result<&crate::core::MetalDevice> {
        match self {
    ...
    pub fn new_metal(ordinal: usize) -> Result<Self> {
        Ok(Self::Metal(crate::core::MetalDevice::new(ordinal)?))
    }
    ...
    pub fn cuda_if_available(ordinal: usize) -> Result<Self> {
        if crate::core::utils::cuda_is_available() {
        ...
        match self {
            ...
            Device::Cuda(device) => {
                ...
                if dtype == DType::F16 || dtype == DType::BF16 {
                    ...
                    Storage::Cuda(storage).to_dtype(&crate::core::Layout::contiguous(shape), dtype)
                } else {
    ...
    pub(crate) fn rand_uniform<T: crate::core::FloatDType>(
        &self,
        lo: T,
        up: T,
        shape: &Shape,
    ...
    pub(crate) fn rand_normal<T: crate::core::FloatDType>(
        &self,
        mean: T,
        std: T,
        shape: &Shape,
