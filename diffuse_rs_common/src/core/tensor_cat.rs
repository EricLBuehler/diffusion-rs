use crate::core::{shape::Dim, Error, Result, Shape, Tensor};
...
impl Tensor {
    ...
    fn cat0<A: AsRef<Tensor>>(args: &[A]) -> Result<Self> {
        ...
        let op = crate::core::op::BackpropOp::new(args, |args| crate::core::op::Op::Cat(args, 0));
        ...
        Ok(crate::core::tensor::from_storage(storage, shape, op, false))
    }
    ...
    fn cat_contiguous<A: AsRef<Tensor>>(args: &[A], dim: usize) -> Result<Self> {
        ...
        let shape = Shape::from(cat_dims);
        let op = crate::core::op::BackpropOp::new(args, |args| crate::core::op::Op::Cat(args, dim));
        let mut storage = unsafe { device.alloc_uninit(&shape, dtype)? };
        let mut dst_o = 0;
