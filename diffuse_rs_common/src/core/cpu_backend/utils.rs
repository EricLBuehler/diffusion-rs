...
use crate::core::{Error, Layout, Result, WithDType};
...
pub trait Map3 {
    ...
    fn map(
        ...
        match (v1, v2, v3) {
            ...
            (C::I32(v1), C::I32(v2), C::I32(v3)) => Ok(self.f(v1, l1, v2, l2, v3, l3, s)?),
...
pub trait Map2Alpha {
    ...
    fn map(&self, v1: &C, l1: &Layout, v2: &C, l2: &Layout, s: Option<f64>) -> Result<C> {
        match (v1, v2) {
            ...
            (C::I32(v1), C::I32(v2)) => Ok(C::I32(self.f(v1, l1, v2, l2, s)?)),
...
pub fn unary_map<T: Copy, U: Copy, F: FnMut(T) -> U>(
    ...
    match layout.strided_blocks() {
        crate::core::StridedBlocks::SingleBlock { start_offset, len } => vs
