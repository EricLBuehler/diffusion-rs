...
use candle_core::{CpuStorage, CustomOp3, Result, Shape, Tensor, WithDType};
...
impl CustomOp3 for DequantizeOp {
    ...
    fn cpu_fwd(
        ...
        match (input_s, absmax_s, code_s, self.out_ty) {
            ...
            (_, _, _, _) => candle_core::bail!(
                "Unsupported dtypes for cpu dequant, expected: u8 input, f32 absmax, f32 code"
            ),
        }
    }
}
