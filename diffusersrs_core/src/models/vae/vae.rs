...
impl Encoder {
    pub fn new(cfg: &VAEConfig, vb: VarBuilder) -> Result<Self> {
        ...
        // https://github.com/huggingface/diffusers/blob/243d9a49864ebb4562de6304a5fb9b9ebb496c6e/src/diffusers/models/unets/unet_2d_blocks.py#L644-L729
        // https://github.com/huggingface/diffusers/blob/243d9a49864ebb4562de6304a5fb9b9ebb496c6e/src/diffusers/models/unets/unet_2d_blocks.py#L625
