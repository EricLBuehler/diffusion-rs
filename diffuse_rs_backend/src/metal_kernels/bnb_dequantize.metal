...
template <typename T>
[[kernel]] void kernel_dequantize_nf4(
...
template <typename T>
[[kernel]] void kernel_dequantize_fp4(
    const device float* code [[buffer(0)]],
    const device uchar* input [[buffer(1)]],
    const device float* absmax [[buffer(2)]],
    device T* out [[buffer(3)]],
...
template <typename T>
[[kernel]] void kernel_dequantize_int8(
    const device float* code [[buffer(0)]],
    const device uchar* input [[buffer(1)]],
    const device float* absmax [[buffer(2)]],
    device T* out [[buffer(3)]],
...
template [[host_name("kernel_dequantize_fp4_" #type )]]         \
[[kernel]] void kernel_dequantize_fp4<type>(                    \
    const device float* code [[buffer(0)]],                     \
    const device uchar* input [[buffer(1)]],                    \
    const device float* absmax [[buffer(2)]],                   \
    device type* out [[buffer(3)]],                             \
...
template [[host_name("kernel_dequantize_int8_" #type )]]        \
[[kernel]] void kernel_dequantize_int8<type>(                   \
    const device float* code [[buffer(0)]],                     \
    const device uchar* input [[buffer(1)]],                    \
    const device float* absmax [[buffer(2)]],                   \
    device type* out [[buffer(3)]],                             \
